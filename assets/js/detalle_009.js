...
const fotos = [
  { src: 'img_009/lote1.png', label: 'Vista principal' },
  { src: 'img_009/lote2.png', label: 'Cocina integral' },
  { src: 'https://imagenes2.eltiempo.com/files/image_1200_535/uploads/2023/06/14/648a10745b5e8.jpeg', label: 'Habitación principal' },
  { src: 'https://thumbs.dreamstime.com/b/land-plot-aerial-view-concept-real-estate-property-identify-registration-symbol-vacant-area-map-business-home-391182349.jpg', label: 'Baño completo' },
  { src: 'img_009/lote3.png', label: 'Balcón' },
  { src: 'img_009/lote4.png', label: 'Segundo ambiente' },
  { src: 'img_009/lote5.png', label: 'Vista exterior' }
];
